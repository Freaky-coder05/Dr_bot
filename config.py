...
'''
use_account = True
Email = "augustocardozor@hotmail.com" #Your email here
Password = "Augusto3232" #Your password here
...
proxy = "http://64.227.134.174:3128" # Proxy URL (e.g., "http://username:password@proxyserver:port")
